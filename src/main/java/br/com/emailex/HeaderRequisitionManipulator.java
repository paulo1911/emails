...
@Named
public class HeaderRequisitionManipulator {
	public HeaderRequisitionManipulator() {
	}
	
	public String getDeviceUser(HttpServletRequest request){
		...
		if (isMobile.matches(
				...
				|| isMobile.substring(0, 4).matches(
			...
			return isMobile = "Acesso via Mobile";
		} else {
			return isMobile = "Acesso via Desktop";
		}
	}
